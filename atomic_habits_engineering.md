...
Can you count how many layers there are now in software products?  3, 4, 10?  So many!   From our code, to open source code, to machine code, to cloud providers, to operating systems, to hardware there is no shortage of layers and complexities.  Us engineers maintaining production software systems quickly appreciate identifying the root causes for effective resolutions, avoiding the swirl of symptom solving.  James Clear brings this same attitude in Atomic Habits when it comes to hacking biological systems, yourself.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjU1NTU4NjQ4LC0yMTQzOTY3OTYzLDIxMz
